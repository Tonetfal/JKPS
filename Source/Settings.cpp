...
std::size_t Settings::StatisticsTextCharacterSize(60);
...
sf::Vector2u Settings::ButtonTextureSize(250, 250);
...
std::size_t Settings::AnimationVelocity(10);
sf::Vector2f Settings::AnimationScale(0.9f, 0.9f);
sf::Color Settings::AnimationColor(sf::Color(255,255,255,100));
